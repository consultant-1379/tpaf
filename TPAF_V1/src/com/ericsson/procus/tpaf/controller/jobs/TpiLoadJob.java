...
public class TpiLoadJob extends JobBase{
	...
	public TpiLoadJob(View view, String fileLocation, ModelFactory modelcreator){
	...
	protected Object call() throws Exception {
		...
		try{
			...
			updateMessage("Attempting to decrypt tpi");
			String copyPath = model.DecryptTpi(fileLocation);
			updateProgress(30, 100);
			
			updateMessage("Parsing tpi into dictionary");
			model.loadDictionaryFromTpi(copyPath);
			updateProgress(65, 100);
			
			updateMessage("Populating model from tpi dictionary");
			model.populateModelFromTPIdictionary();

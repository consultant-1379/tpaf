...
public class XMLLoad extends JobBase{
	...
	public XMLLoad(View view, String fileLocation, ModelFactory modelcreator){
	...
	protected Object call() throws Exception {
		...
		try{
			...
			updateMessage("Populating model from XML file");
			model.populateModelFromXML(fileLocation);
